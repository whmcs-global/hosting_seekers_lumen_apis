...
trait SendResponseTrait {
    ...
    public function validateToken($token = NULL, $requestDetail = null){
        ...
        if(($browse_detail['ip'] == $token_array[0] || $token_array[0] == '127.0.0.1' || $token_array[0] == '172.70.92.177') && $browse_detail['os'] == $token_array[2] && $browse_detail['browser'] == $token_array[1])
        return TRUE;
        else
        return FALSE;
    }
